/*
 * @(#)FeatListRuleSet.java 1.00 22/10/2014 Copyright 2014 CPA Consulting LTDA.
 ...
 */
public class FeatListRuleSet extends RuleSetBase {

    private static final String BASE_PATH = "feat_list/feat";

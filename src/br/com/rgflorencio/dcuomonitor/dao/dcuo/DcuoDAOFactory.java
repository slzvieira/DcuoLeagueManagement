/*
 * @(#)DcuoDAOFactory(){} 1.00 25/08/2015 Copyright 2015 CPA Consulting LTDA.
 ...
 */
public class DcuoDAOFactory {

    /** The singleton instance. */
    private static final DcuoDAOFactory INSTANCE = new DcuoDAOFactory();
     ...
     */
    public static DcuoDAOFactory getInstance() {
        return INSTANCE;
    }
    ...
    public DcuoLeagueDAO getDcuoLeagueDAO() {
        return newInstance(DcuoLeagueDAO.class);
    }
    ...
    private <T> T newInstance(Class<? super T> clazz) {
        ...
        try {
            ...
            throw new RuntimeException("Falha ao instancia TransactionalDAO.", e);
        }
    }
}
